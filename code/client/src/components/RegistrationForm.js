...
const RegistrationForm = (props) => {
  ...
  const getClientSecret = async () => {
    await fetch('/create-setup-intent', { method: 'GET'})
        .then(async (response) => {
  ...
  const createClient = async () => {
    await fetch('/create-client', { method: 'POST',
      body: JSON.stringify({name: learnerName, email: learnerEmail, firstLesson: details}),
      headers: {
